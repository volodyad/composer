...
const AssetRegistry = require('@sp-temp/composer-client/lib/assetregistry');
...
const IdentityRegistry = require('@sp-temp/composer-client/lib/identityregistry');
...
const ReturnsDecoratorFactory = require('@sp-temp/composer-common').ReturnsDecoratorFactory;
const Serializer = require('@sp-temp/composer-common').Serializer;
const TransactionRegistry = require('@sp-temp/composer-client/lib/transactionregistry');
const Historian = require('@sp-temp/composer-client/lib/historian');
const TypeNotFoundException = require('@sp-temp/composer-common/lib/typenotfoundexception');
